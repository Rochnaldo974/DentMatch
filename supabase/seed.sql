...
--
-- Comptes créés (email / mot de passe) — toutes les données sont localisées à La Réunion :
--   demo.cabinet@dentmatch.example        / DemoCabinet2026!      (cabinet, Saint-Pierre)
--   cabinet.saintpaul@dentmatch.example   / DemoCabinet2026!      (cabinet, Saint-Paul)
--   cabinet.reunion@dentmatch.example     / DemoCabinet2026!      (cabinet, Saint-Denis)
--   cabinet.tampon@dentmatch.example      / DemoCabinet2026!      (cabinet, Le Tampon)
--   cabinet.saintandre@dentmatch.example  / DemoCabinet2026!      (cabinet, Saint-André)
--   demo.remplacant@dentmatch.example     / DemoRemplacant2026!   (remplaçante diplômée, Saint-Denis)
--   remplacant.etudiant@dentmatch.example / DemoRemplacant2026!   (étudiant autorisé, Le Tampon)
--   remplacant.interne@dentmatch.example  / DemoRemplacant2026!   (interne ODF, Saint-Pierre)
--   remplacant.marseille@dentmatch.example/ DemoRemplacant2026!   (remplaçant diplômé, Saint-Paul)
...
declare
  users constant jsonb := '[
    ...
    {"id":"11111111-1111-4111-8111-111111111102","email":"cabinet.saintpaul@dentmatch.example","pw":"DemoCabinet2026!","first":"Marc","last":"Lemoine","role":"cabinet"},
    ...
    {"id":"11111111-1111-4111-8111-111111111104","email":"cabinet.tampon@dentmatch.example","pw":"DemoCabinet2026!","first":"Patrick","last":"Solvet","role":"cabinet"},
    {"id":"11111111-1111-4111-8111-111111111105","email":"cabinet.saintandre@dentmatch.example","pw":"DemoCabinet2026!","first":"Aline","last":"Marie-Sainte","role":"cabinet"},
...
-- Photos de profil des remplaçants (portraits de démonstration)
update public.profiles set avatar_url = 'https://randomuser.me/api/portraits/women/44.jpg'
where id = '22222222-2222-4222-8222-222222222201';
update public.profiles set avatar_url = 'https://randomuser.me/api/portraits/men/32.jpg'
where id = '22222222-2222-4222-8222-222222222202';
update public.profiles set avatar_url = 'https://randomuser.me/api/portraits/women/68.jpg'
where id = '22222222-2222-4222-8222-222222222203';
update public.profiles set avatar_url = 'https://randomuser.me/api/portraits/men/51.jpg'
...
insert into public.cabinet_profiles (
  ...
  ('aaaaaaaa-0000-4000-8000-000000000001', '11111111-1111-4111-8111-111111111101',
   'titulaire', 'demo.cabinet@dentmatch.example', 'Cabinet dentaire du Lagon', 'cabinet_groupe',
   '12345678900011', 'Cabinet de groupe moderne à deux pas du front de mer de Saint-Pierre. Plateau technique complet, patientèle fidèle et équipe stable de trois praticiens.',
   '12 boulevard Hubert-Delisle', '97410', 'Saint-Pierre', 'La Réunion', 'La Réunion', 'La Réunion',
   '02 62 25 00 01', 'demo.cabinet@dentmatch.example', 3, 4, 4, 'Logos', true, true,
   array['Français','Anglais'], 'urbain', 95),
  ('aaaaaaaa-0000-4000-8000-000000000002', '11111111-1111-4111-8111-111111111102',
   'associe', 'cabinet.saintpaul@dentmatch.example', 'Cabinet de l''Ermitage', 'societe_exercice',
   '98765432100022', 'Cabinet orienté omnipratique et esthétique, entre Saint-Gilles et l''Ermitage. Patientèle familiale et touristique.',
   '45 rue du Général-de-Gaulle', '97434', 'Saint-Paul', 'La Réunion', 'La Réunion', 'La Réunion',
   '02 62 33 00 02', 'cabinet.saintpaul@dentmatch.example', 2, 2, 3, 'Julie', true, false,
  ...
  ('aaaaaaaa-0000-4000-8000-000000000004', '11111111-1111-4111-8111-111111111104',
   'responsable_centre', 'cabinet.tampon@dentmatch.example', 'Centre dentaire du Tampon', 'centre_sante',
   '78912345600044', 'Centre de santé dentaire du Tampon, équipe pluridisciplinaire, forte activité, patientèle des Hauts.',
   '23 rue Hubert-Delisle', '97430', 'Le Tampon', 'La Réunion', 'La Réunion', 'La Réunion',
   '02 62 27 00 04', 'cabinet.tampon@dentmatch.example', 4, 6, 6, 'Desmos', true, true,
   array['Français','Créole'], 'urbain', 88),
  ('aaaaaaaa-0000-4000-8000-000000000005', '11111111-1111-4111-8111-111111111105',
   'titulaire', 'cabinet.saintandre@dentmatch.example', 'Cabinet des Flamboyants', 'cabinet_groupe',
   '32165498700055', 'Cabinet de groupe à Saint-André, plateau récent (cone beam, CFAO), stationnement facile.',
   '15 avenue de Bourbon', '97440', 'Saint-André', 'La Réunion', 'La Réunion', 'La Réunion',
   '02 62 46 00 05', 'cabinet.saintandre@dentmatch.example', 2, 3, 3, 'Logos', false, true,
...
insert into public.replacement_profiles (
  ...
  ('bbbbbbbb-0000-4000-8000-000000000001', '22222222-2222-4222-8222-222222222201',
   ...
   'Chirurgienne-dentiste diplômée de Bordeaux, installée à Saint-Denis. 6 ans d''expérience en omnipratique. Rigoureuse, autonome et à l''écoute des patients. Disponible sur toute l''île.',
   ...
   6, array['Français','Anglais'], 100, true, true, true, false,
  ...
  ('bbbbbbbb-0000-4000-8000-000000000002', '22222222-2222-4222-8222-222222222202',
   ...
   'Étudiant en 6e année (5e année validée, CSCT obtenu), originaire du Tampon. Motivé, sérieux, à la recherche de remplacements pour l''été austral.',
  ...
  ('bbbbbbbb-0000-4000-8000-000000000003', '22222222-2222-4222-8222-222222222203',
   ...
   'Interne en orthopédie dento-faciale (2e année), en stage au CHU sud de Saint-Pierre. Disponible ponctuellement pour des remplacements en orthodontie.',
   ...
   'CHU de La Réunion — site Sud (Saint-Pierre)', true, 2, array['Français','Anglais'], 150, false, true, true, false,
  ...
  ('bbbbbbbb-0000-4000-8000-000000000004', '22222222-2222-4222-8222-222222222204',
   ...
   'Omnipraticien expérimenté (10 ans), installé dans l''Ouest. À l''aise sur la chirurgie et l''implantologie. Recherche remplacements longue durée.',
...
-- Zones de mobilité (zones de l'île de La Réunion)
insert into public.mobility_areas (user_id, area_type, area_value) values
  ('22222222-2222-4222-8222-222222222201', 'region', 'nord'),
  ('22222222-2222-4222-8222-222222222201', 'region', 'ouest'),
  ('22222222-2222-4222-8222-222222222201', 'region', 'sud'),
  ('22222222-2222-4222-8222-222222222201', 'region', 'est'),
  ('22222222-2222-4222-8222-222222222202', 'region', 'sud'),
  ('22222222-2222-4222-8222-222222222202', 'region', 'hauts'),
  ('22222222-2222-4222-8222-222222222203', 'region', 'sud'),
  ('22222222-2222-4222-8222-222222222203', 'region', 'ouest'),
  ('22222222-2222-4222-8222-222222222204', 'region', 'ouest'),
  ('22222222-2222-4222-8222-222222222204', 'region', 'nord')
on conflict do nothing;

-- Disponibilités
insert into public.availabilities (user_id, type, start_date, end_date, recurring_days, notes) values
  ('22222222-2222-4222-8222-222222222201', 'plage', current_date + 7, current_date + 45, '{}', 'Disponible immédiatement, mobile sur toute l''île.'),
...
insert into public.job_posts (
  ...
  ('cccccccc-0000-4000-8000-000000000001', 'aaaaaaaa-0000-4000-8000-000000000001',
   '11111111-1111-4111-8111-111111111101', 'Remplacement omnipratique — Saint-Pierre',
   ...
   'Saint-Pierre', '97410', 'La Réunion', 'La Réunion', 'La Réunion', now() - interval '6 days'),
  ('cccccccc-0000-4000-8000-000000000002', 'aaaaaaaa-0000-4000-8000-000000000002',
   '11111111-1111-4111-8111-111111111102', 'Remplacement urgent — Saint-Paul',
   ...
   'Saint-Paul', '97434', 'La Réunion', 'La Réunion', 'La Réunion', now() - interval '1 day'),
  ...
  ('cccccccc-0000-4000-8000-000000000004', 'aaaaaaaa-0000-4000-8000-000000000004',
   '11111111-1111-4111-8111-111111111104', 'Collaboration temporaire — Le Tampon',
   ...
   'Le Tampon', '97430', 'La Réunion', 'La Réunion', 'La Réunion', now() - interval '10 days'),
  ('cccccccc-0000-4000-8000-000000000005', 'aaaaaaaa-0000-4000-8000-000000000005',
   '11111111-1111-4111-8111-111111111105', 'Remplacement orthodontie — Saint-André',
   ...
   'Saint-André', '97440', 'La Réunion', 'La Réunion', 'La Réunion', now() - interval '2 days'),
  ('cccccccc-0000-4000-8000-000000000006', 'aaaaaaaa-0000-4000-8000-000000000001',
   '11111111-1111-4111-8111-111111111101', 'Remplacement d''été — Saint-Pierre (brouillon)',
   ...
   'Saint-Pierre', '97410', 'La Réunion', 'La Réunion', 'La Réunion', null)
on conflict (id) do nothing;
...
insert into public.applications (
  ...
  -- Acceptée : Camille → Cabinet du Lagon (Saint-Pierre)
  ...
  -- En attente : Julien → Saint-Pierre
  ...
  -- Envoyée : Camille → Saint-Denis
  ('dddddddd-0000-4000-8000-000000000003', 'cccccccc-0000-4000-8000-000000000003',
   '22222222-2222-4222-8222-222222222201', 'submitted',
   'Bonjour, installée à Saint-Denis, je serais ravie de vous remplacer pendant vos congés. Je suis autonome et la période me convient parfaitement.',
   true, now() - interval '2 days', null, null),
  -- Envoyée : Théo (étudiant) → Saint-Paul urgent
  ('dddddddd-0000-4000-8000-000000000004', 'cccccccc-0000-4000-8000-000000000002',
   '22222222-2222-4222-8222-222222222202', 'submitted',
   'Bonjour, étudiant en 6e année (5e année validée, CSCT obtenu, licence de remplacement en cours de validité), je suis disponible immédiatement sur Saint-Paul.',
   true, now() - interval '12 hours', null, null),
  -- Refusée : Julien → Le Tampon
  ('dddddddd-0000-4000-8000-000000000005', 'cccccccc-0000-4000-8000-000000000004',
   '22222222-2222-4222-8222-222222222204', 'rejected',
   'Bonjour, très intéressé par une longue mission au Tampon.',
...
insert into public.notifications (user_id, type, title, body, metadata, read_at, created_at) values
  ('22222222-2222-4222-8222-222222222201', 'application_accepted', 'Candidature acceptée',
   'Votre candidature pour « Remplacement omnipratique — Saint-Pierre » a été acceptée. Une conversation est ouverte avec le cabinet.',
  ...
  ('11111111-1111-4111-8111-111111111101', 'new_application', 'Nouvelle candidature reçue',
   'Un remplaçant a candidaté à votre annonce « Remplacement omnipratique — Saint-Pierre ».',
