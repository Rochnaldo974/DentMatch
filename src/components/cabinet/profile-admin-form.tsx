...
/** Édition des informations administratives du cabinet (réutilise l'étape 2 de l'onboarding). */
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Informations déclarées : elles permettent aux remplaçants
          d&apos;identifier votre structure.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
