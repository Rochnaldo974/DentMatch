...
// Les champs numériques (z.coerce) et les valeurs par défaut du schéma rendent
// z.input différent de z.output : on aligne le resolver sur les valeurs du
// formulaire (la validation Zod reste inchangée à l'exécution).
const step3Resolver = zodResolver(
  cabinetStep3Schema,
) as unknown as Resolver<CabinetStep3Input>;

/** Étape 3 — Présentation du cabinet. */
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input list="dental-software-suggestions" {...field} />
                    </FormControl>
                    <datalist id="dental-software-suggestions">
